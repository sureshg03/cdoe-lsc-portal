...
export const AdminDashboard = () => {
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard, color: 'text-indigo-600', path: '/dashboard/admin' },
    { id: 'admission-management', label: 'Admission Management', icon: GraduationCap, color: 'text-purple-600', path: '/dashboard/admin/admission-management' },
    { id: 'applications', label: 'New Student Application', icon: UserPlus, color: 'text-orange-600', path: '/dashboard/admin/applications' },
    { id: 'lsc-management', label: 'LSC Management', icon: Building2, color: 'text-cyan-600', path: '/dashboard/admin/lsc-management' },
    { id: 'settings', label: 'Settings', icon: Settings, color: 'text-gray-600', path: '/dashboard/admin/settings' },
    { id: 'users', label: 'User Management', icon: Users, color: 'text-purple-600', path: '/dashboard/admin/users' },
    { id: 'admissions', label: 'Student Admission Details', icon: Users, color: 'text-blue-600', path: '/dashboard/admin/admissions' },
    { id: 'reports', label: 'Reports & Analytics', icon: FileText, color: 'text-teal-600', path: '/dashboard/admin/reports' },
    { id: 'materials', label: 'Materials', icon: BookOpen, color: 'text-green-600', path: '/dashboard/admin/materials' },
    { id: 'counselor', label: 'Counselor Information', icon: User, color: 'text-pink-600', path: '/dashboard/admin/counselor' },
    { id: 'attendance', label: 'Attendance', icon: Calendar, color: 'text-yellow-600', path: '/dashboard/admin/attendance' },
    { id: 'assignments', label: 'Assignment Marks', icon: FileText, color: 'text-red-600', path: '/dashboard/admin/assignments' },
    { id: 'system', label: 'System Settings', icon: Database, color: 'text-emerald-600', path: '/dashboard/admin/system' },
    { id: 'password', label: 'Change Password', icon: Lock, color: 'text-rose-600', path: '/dashboard/admin/password' },
  ];
