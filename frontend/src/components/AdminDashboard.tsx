...
export const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: 'admission-management', label: 'Admission Management', icon: GraduationCap, color: 'text-purple-600' },
    { id: 'settings', label: 'Settings', icon: Settings, color: 'text-gray-600' },
    { id: 'users', label: 'User Management', icon: Users, color: 'text-purple-600' },
    { id: 'admissions', label: 'Student Admission Details', icon: Users, color: 'text-blue-600' },
    { id: 'applications', label: 'New Student Application', icon: UserPlus, color: 'text-orange-600' },
    { id: 'reports', label: 'Reports & Analytics', icon: FileText, color: 'text-teal-600' },
    { id: 'materials', label: 'Materials', icon: BookOpen, color: 'text-green-600' },
    { id: 'counselor', label: 'Counselor Information', icon: User, color: 'text-pink-600' },
    { id: 'attendance', label: 'Attendance', icon: Calendar, color: 'text-yellow-600' },
    { id: 'assignments', label: 'Assignment Marks', icon: FileText, color: 'text-red-600' },
    { id: 'lsc-management', label: 'LSC Management', icon: Building2, color: 'text-cyan-600' },
    { id: 'system', label: 'System Settings', icon: Database, color: 'text-emerald-600' },
    { id: 'password', label: 'Change Password', icon: Lock, color: 'text-rose-600' },
  ];
